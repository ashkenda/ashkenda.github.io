...
<div class="row justify-content-sm-center">
    <div class="col-sm-auto mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/presenting.JPEG" title="my poster" class="img-fluid rounded z-depth-1" style="height: 250px; width: auto;" %}
    </div>
    <div class="col-sm-auto mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/undergrad.PNG" title="beaver dams" class="img-fluid rounded z-depth-1" style="height: 250px; width: auto;" %}
    </div>
</div>
<div class="caption">
