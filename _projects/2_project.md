...
<div class="row justify-content-sm-center align-items-start">
    ...
    <div class="col-sm-auto mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/undergrad.PNG" title="beaver dams" class="img-fluid rounded z-depth-1" style="height: 100%; max-height: 400px; width: auto;" %}
    </div>
</div>
<div class="caption">
